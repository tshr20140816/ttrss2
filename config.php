<?php
	...
	define('DB_HOST', getenv('postgres_server'));
	define('DB_USER', getenv('postgres_user'));
	define('DB_NAME', getenv('postgres_dbname'));
	...
	define('LOCK_DIRECTORY', '/tmp/lock');
	...
	define('ICONS_DIR', '/app/www/ttrss/feed-icons');
