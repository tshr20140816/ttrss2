...
error_log(floor(($dyno_quota - $dyno_used) / 86400));
error_log($last_day);
...
$xml_text = str_replace('__TITLE__', $quota . ' ' . number_format($count_record), $xml_text);
...
$xml_text = str_replace('__GUID__', hash('sha256', $quota), $xml_text);
echo $xml_text;
